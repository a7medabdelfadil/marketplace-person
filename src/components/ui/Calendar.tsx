...
function Calendar({
  ...
  return (
    <div className="rounded-xl bg-bgPrimary w-full flex flex-col items-center">
      <DayPicker
        ...
        classNames={{
          ...
          caption: "flex justify-center gap-2 md:justify-between items-center pb-2 w-full",
          ...
          nav_button_previous:
            "md:border border-borderPrimary absolute -left-48 md:left-0 bg-bgPrimary rounded-full md:rounded-none md:rounded-l-lg text-textSecondary hover:bg-bgSecondary",
          nav_button_next:
            "bg-primary/10 md:bg-primary2 text-white rounded-full md:rounded-none md:rounded-r-lg hover:bg-primaryHover md:hover:bg-primary2Hover",
          table: "w-full border-collapse text-center rounded-xl md:shadow-md",
          head_row: "grid grid-cols-7 text-primary md:text-primary2 px-4 font-semibold text-sm",
          ...
          day_selected: "bg-primary md:bg-primary2 text-white font-bold",
          day_today:
        ...
        components={{
          ...
          IconRight: ({ className, ...props }) => (
            <ChevronRight className={cn("h-5 w-5 text-primary md:text-white", className)} {...props} />
          ),
        }}
        {...props}
      />
