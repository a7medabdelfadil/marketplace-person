    ...
    <div className="flex w-full flex-col items-center rounded-xl bg-bgPrimary">
      <DayPicker
        ...
        classNames={{
          ...
          caption_label:
            "text-lg font-semibold text-textPrimary flex-1 text-center",
          ...
          head_row:
            "grid grid-cols-7 text-textPrimary px-4 font-medium text-sm",
          ...
          day_selected:
            "bg-primary2 text-white rounded-full font-bold hover:bg-primary2Hover",
          day_today:
