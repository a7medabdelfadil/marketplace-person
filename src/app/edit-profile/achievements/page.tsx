                  ...
                  <div>
                    {items.map((item, index) => (
                      <div
                        ...
                        className={`${index === 0 ? "mt-0" : "mt-4"} ${index === 9 ? "bg-bgPrimary" : ""} flex min-w-[150px] cursor-pointer gap-2 rounded-xl py-2 pl-2`}
                      >
                        <img
                          src={item.src}
                          alt={item.alt}
                  ...
                  <div className="mx-4 mt-8 flex justify-center lg:mx-0">
                    <div className="w-full rounded-xl border bg-bgPrimary p-6 lg:w-4/5">
                      ...
                      <p className="mt-2 text-textSecondary">
                        {maxCharacters - achievement.length}{" "}
                        {t.charactersRemaining} {maxCharacters})
                      </p>
