        ...
        <div className="flex gap-5">
          ...
          <div>
            <div className="mx-4 mb-4 flex items-center gap-4">
              ...
              <p onClick={() => router.push("/education/courses")} className="cursor-pointer text-primary underline">All</p>
              <p onClick={() => router.push("/education/courses/1/enrolled")} className="cursor-pointer text-textPrimary">Enrolled</p>
              <p onClick={() => router.push("/education/courses/1/completed")} className="cursor-pointer text-textPrimary">Completed</p>
            </div>
            <Box padding="0" rounded="none">
              <div className="flex flex-wrap gap-4 mx-4 p-4">
                <select className="flex-1 curser-pointer rounded-lg border border-borderPrimary bg-offWhite px-6 py-4 text-textPrimary outline-none transition duration-300 hover:shadow-md">
